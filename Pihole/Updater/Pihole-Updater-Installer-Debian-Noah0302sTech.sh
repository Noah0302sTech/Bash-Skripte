...
#Cron-Check
	...
	echo "Cron lief am:" >> /home/'$SUDO_USER'/Noah0302sTech/'$folderVar'/'$subFolderVar'/Cron-Check.txt
	date >> /home/'$SUDO_USER'/Noah0302sTech/'$folderVar'/'$subFolderVar'/Cron-Check.txt' > Pihole-Updater.sh
