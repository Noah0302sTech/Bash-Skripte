...
# chmod +x Docker-System-Prune-Installer.sh && sudo bash Docker-System-Prune-Installer.sh
...
#----- Create Folders
	...
	#--- Move Files
		start_spinner "Verschiebe Bash-Skript..."
			#- Docker-System-Prune-Installer.sh
				if [ ! -f /home/$SUDO_USER/Noah0302sTech/Docker/Installer/Docker-System-Prune-Installer.sh ]; then
					mv /home/$SUDO_USER/Docker-System-Prune-Installer.sh /home/$SUDO_USER/Noah0302sTech/Docker/Installer/Docker-System-Prune-Installer.sh > /dev/null 2>&1
				else
