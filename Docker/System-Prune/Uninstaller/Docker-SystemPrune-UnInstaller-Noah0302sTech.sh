...
#	wget https://raw.githubusercontent.com/Noah0302sTech/Bash-Skripte/master/Docker/System-Prune/Uninstaller/Docker-SystemPrune-UnInstaller-Noah0302sTech.sh && sudo bash Docker-SystemPrune-UnInstaller-Noah0302sTech.sh
