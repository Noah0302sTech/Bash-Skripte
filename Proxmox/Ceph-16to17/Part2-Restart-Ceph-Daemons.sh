...
#	wget https://raw.githubusercontent.com/Noah0302sTech/Bash-Skripte/testing/Proxmox/Ceph-16to17/Part2-Restart-Ceph-Daemons.sh && bash Part2-Restart-Ceph-Daemons.sh
...
#Move Bash-Script
	mv Part2-Restart-Ceph-Daemons.sh Ceph-16to17/Part2-Restart-Ceph-Daemons.sh
...
#Upgrade all CephFS MDS daemons
	echo "ACHTUNG, die CephFS-MDS sollten erst geupgraded werden, wenn ALLE non-zero ranks deaktiviert sind!"
